...
module.exports = function(options){
	...
	opt.toc_title = options.toc_title || 'Table of Contents';
	opt.tp_title = options.tp_title || 'Title Page';
	
	opt.write_tp = options.write_tp || true;
	opt.write_toc = options.write_toc || true;
	opt.subjects = options.subjects || [];
	opt.smarten_titles = options.smarten_titles || true;
